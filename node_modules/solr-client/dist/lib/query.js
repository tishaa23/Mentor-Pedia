...
class Query {
     ...
     * @api public
     */
    q(q, matchFilterOptions) {
        const self = this;
        const parameter = typeof q === 'string'
     ...
     */
    matchFilter(field, value, matchFilterOptions) {
        const self = this;
        let parameter = 'fq=';
        if (Array.isArray(value)) {
            ...
            field = (matchFilterOptions === null || matchFilterOptions === void 0 ? void 0 : matchFilterOptions.complexPhrase)
    ...
    fq(filters) {
        ...
        if (Array.isArray(filters)) {
            filters.map((f) => this.matchFilter(f.field, f.value, f.matchFilterOptions));
            return self;
        }
        if (filters instanceof Object) {
            return this.matchFilter(filters.field, filters.value, filters.matchFilterOptions);
        }
        else {
